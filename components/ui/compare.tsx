...
export const Compare = ({
  ...
  return (
    <div
      ...
      onMouseLeave={() => { if (slideMode === "hover") setSliderXPercent(initialSliderPercentage); setIsDragging(false); startAutoplay(); }}
      onMouseEnter={() => stopAutoplay()}
      onMouseDown={() => slideMode === "drag" && setIsDragging(true)}
      onMouseUp={() => setIsDragging(false)}
      onTouchMove={(e) => !autoplay && handleMove(e.touches[0].clientX)}
      onTouchStart={() => !autoplay && slideMode === "drag" && setIsDragging(true)}
