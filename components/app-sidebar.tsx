...
export function AppSidebar() {
  ...
  const navigation = [
    ...
    {
      name: pt ? "Clientes" : "Clients",
      href: "/clientes",
      icon: "M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z",
    },
    {
      name: pt ? "Configurações" : "Settings",
      href: "/settings",
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-40 w-64 border-r bg-white">
      ...
      <nav className="flex flex-col gap-1 p-4" aria-label={pt ? "Navegação principal" : "Main navigation"}>
        {navigation.map((item) => {
